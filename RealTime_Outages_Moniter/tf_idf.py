...
lang        = 'english'
lang_dictionary     = {}
top_k               = 0.2 # no less then tf-idf 0.2
...
print("######### Begin using TF-IDF to walk through threads ###########")
...
writer = open( 'total_threads_after_tfidf.txt', 'w')
for f in all_files: 
    result = []
...
os.system("python caculate_words_cnt.py total_threads_after_tfidf.txt")
